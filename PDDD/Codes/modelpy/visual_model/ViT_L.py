...
class PatchEmbedding(nn.Module):
    def __init__(self, channels=3, patch_size=16, embed_size=1024, img_size=224):
...
class TransformerEncoderBlock(nn.Module):
    def __init__(self, embed_size=1024, dropout_p=0, expansion=4):
        ...
        self.attn = nn.MultiheadAttention(embed_size, 16, dropout_p) # default head_count = 12
...
class TransformerEncoder(nn.Module):
    def __init__(self, layer_num=24, embed_size=1024, dropout_p=0, expansion=4):
...
class VisionTransformer(nn.Module):
    def __init__(self, channels=3, patch_size=16, embed_size=1024, img_size=224, block_num=12, class_num=118):
